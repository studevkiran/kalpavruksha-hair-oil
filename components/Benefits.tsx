  ...
  const benefits = [
    {
      ...
      description: 'Stimulates follicles and accelerates natural hair growth with powerful botanicals',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Strengthens roots and reduces breakage for visibly thicker, healthier hair',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Natural antifungal properties keep your scalp clean and flake-free',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: 'Balances Scalp Heat',
      description: 'Cooling herbs soothe irritation and maintain optimal scalp temperature',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Deep nourishment fortifies hair from the roots for lasting resilience',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Restores lustre and vitality with vitamin-rich herbal infusions',
    },
  ]
