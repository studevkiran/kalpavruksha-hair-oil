...
export default function HeroSection() {
  return (
    <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-gradient-to-br from-brand-green-100 via-brand-green-50 to-brand-earth-100">
      {/* Animated background elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-10 w-72 h-72 bg-brand-green-300/40 rounded-full blur-3xl animate-float-slow" />
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-brand-earth-300/40 rounded-full blur-3xl animate-float-slower" style={{ animationDelay: '1s' }} />
        <div className="absolute top-1/2 left-1/3 w-64 h-64 bg-brand-gold-300/30 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }} />
        
        {/* Oil drops animation */}
        <div className="absolute top-10 left-1/4 w-4 h-4 bg-brand-green-600 rounded-full animate-oil-drop" style={{ animationDelay: '0s' }} />
        <div className="absolute top-20 right-1/3 w-3 h-3 bg-brand-green-500 rounded-full animate-oil-drop" style={{ animationDelay: '1s' }} />
        <div className="absolute top-32 left-1/2 w-5 h-5 bg-brand-earth-500 rounded-full animate-oil-drop" style={{ animationDelay: '2s' }} />
        <div className="absolute top-5 right-1/4 w-3 h-3 bg-brand-gold-500 rounded-full animate-oil-drop" style={{ animationDelay: '1.5s' }} />
